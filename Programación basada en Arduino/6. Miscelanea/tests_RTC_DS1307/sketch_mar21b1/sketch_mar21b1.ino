...
void loop() {
  Serial.print("DS1307 options:");
  Serial.print("1) Read date from DS1307");
  Serial.print("2) Write date into DS1307");
  Serial.print("3) load new date");
  Serial.print("4) show new date");
  char c = Serial.read();
  if(c=='1'){
